...
function team.getHighestPkmToLvl(level_cap)
    return team._compare(team.getPkmToLvl(level_cap), gen.maxLvl)
end

function team.getHighestAlivePkmToLvl(level_cap)
    return team._compare(team.getAlivePkmToLvl(level_cap), gen.maxLvl)
end
...
function team.getHighestUsablePkmToLvl(level_cap)
    return team._compare(team.getUsablePkmToLvl(level_cap), gen.maxLvl)
end
