...
local P21MarshBadgeQuest = Quest:new()

function P21MarshBadgeQuest:new()
    if not KANTO_DOJO_POKEMON_ID then
        KANTO_DOJO_POKEMON_ID = math.random(1, 2)
    end
    local o = Quest.new(P21MarshBadgeQuest, name, description, level, dialogs)
    o.dojoState = false
    return o
end

function P21MarshBadgeQuest:isDoable()
...
function P21MarshBadgeQuest:isDone()
...
function P21MarshBadgeQuest:SaffronCity()
...
function P21MarshBadgeQuest:PokecenterSaffron()
    return self:pokecenter("Saffron City")
end

function P21MarshBadgeQuest:SaffronDojo()
...
function P21MarshBadgeQuest:SaffronGym()
...
function P21MarshBadgeQuest:Route8StopHouse()
    if not hasItem("Marsh Badge") then
...
function P21MarshBadgeQuest:Route8()
