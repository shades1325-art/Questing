...
local P26ReviveFossilQuest = Quest:new()

function P26ReviveFossilQuest:new()
	return Quest.new(P26ReviveFossilQuest, name, description, level)
end

function P26ReviveFossilQuest:isDoable()
	return self:hasMap()
end

function P26ReviveFossilQuest:isDone()
	return getMapName() == "Cinnabar Island"
end

function P26ReviveFossilQuest:CinnabarLab()
...
function P26ReviveFossilQuest:CinnabarLabRoom3()
