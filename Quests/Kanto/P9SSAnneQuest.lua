...
local P9SSAnneQuest = Quest:new()

function P9SSAnneQuest:new()
	local o = Quest.new(P9SSAnneQuest, name, description, level, dialogs)
...
function P9SSAnneQuest:isDoable()
...
function P9SSAnneQuest:SSAnne1F()
...
function P9SSAnneQuest:SSAnneBasementRoom5()
...
function P9SSAnneQuest:SSAnneBasement()
...
function P9SSAnneQuest:SSAnneBasementRoom4()
...
function P9SSAnneQuest:SSAnne1FKitchen()
	if dialogs.NeedPharmacist.state or dialogs.KitchenDone.state then
...
function P9SSAnneQuest:SSAnne2F()
	if hasItem("Secret Potion") then
...
function P9SSAnneQuest:SSAnne2FRoom6()
	if dialogs.PharmacistWorking.state then
		sys.debug("quest", "Going to SS Anne 2F.")
...
function P9SSAnneQuest:SSAnne3F()
...
function P9SSAnneQuest:SSAnne3FBattleRoom()
...
function P9SSAnneQuest:BallroomSSAnne()
...
function P9SSAnneQuest:SSAnne2FCaptainRoom()
...
-- in case of blackout
function P9SSAnneQuest:PokecenterVermilion()
	self:pokecenter("Vermilion City")
end

function P9SSAnneQuest:VermilionCity()
	return moveToCell(40, 67)
end

return P9SSAnneQuest