...
local P30GoToJohtoQuest = Quest:new()

function P30GoToJohtoQuest:new()
	local o = Quest.new(P30GoToJohtoQuest, name, description, level)
	o.pokemonId = 1
	return o
end

function P30GoToJohtoQuest:isDoable()
...
function P30GoToJohtoQuest:isDone()
...
function P30GoToJohtoQuest:Route26()
	sys.debug("quest", "Going to Johto.")
	return moveToCell(0, 105)
end

function P30GoToJohtoQuest:Route27()
...
function P30GoToJohtoQuest:TohjoFalls()
	sys.debug("quest", "Going to Johto.")
	return moveToCell(23,32)
end

return P30GoToJohtoQuest