...
function beatDeoxys:isDoable()
	if self:hasMap() and not hasItem("Blue Orb") and hasItem("Rain Badge") then
		return true
	end
	return false
end
...
function beatDeoxys:isDone()
	--if hasItem("HM07 - Waterfall") and getMapName() == "Sootopolis City Gym B1F" then
	if getMapName() == "Ever Grande City" then
		return true
	else
		return false
	end
...
function beatDeoxys:CaveofOriginEntrance()
...
function beatDeoxys:CaveofOrigin1F()
	if not hasItem("HM07 - Waterfall") then
		sys.debug("quest", "Going to get HM07 - Waterfall")
...
function beatDeoxys:CaveofOriginB1F()
	if not hasItem("HM07 - Waterfall") then
		sys.debug("quest", "Going to get HM07 - Waterfall")
...
function beatDeoxys:CaveofOriginB2F()
	if not hasItem("HM07 - Waterfall") then
		sys.debug("quest", "Going to get HM07 - Waterfall")
...
function beatDeoxys:CaveofOriginB3F()
