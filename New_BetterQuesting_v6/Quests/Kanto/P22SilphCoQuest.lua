...
local P22SilphCoQuest = Quest:new()

function P22SilphCoQuest:new()
	return Quest.new(P22SilphCoQuest, name, description, level, dialogs)
end

function P22SilphCoQuest:isDoable()
...
function P22SilphCoQuest:isDone()
...
function P22SilphCoQuest:SilphCo1F()
...
function P22SilphCoQuest:SilphCo2F()
...
function P22SilphCoQuest:SilphCo3F()
	if not dialogs.silphCoDone.state then
...
function P22SilphCoQuest:SilphCo7F()
	if not dialogs.silphCoDone.state then
...
function P22SilphCoQuest:SilphCo11F()
