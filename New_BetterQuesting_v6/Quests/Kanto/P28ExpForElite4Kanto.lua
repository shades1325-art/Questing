...
local P28ExpForElite4Kanto = Quest:new()

function P28ExpForElite4Kanto:new()
	local o = Quest.new(P28ExpForElite4Kanto, name, description, level, dialogs)
...
function P28ExpForElite4Kanto:isDoable()
...
function P28ExpForElite4Kanto:isDone()
...
function P28ExpForElite4Kanto:buyReviveItems() --return false if all items are on the bag (32x Revives 32x HyperPotions)
...
function P28ExpForElite4Kanto:canBuyReviveItems()
...
function P28ExpForElite4Kanto:reviveItemCost()
	local bag_revive = getItemQuantity("Revive")
	local bag_hyperpot = getItemQuantity("Hyper Potion")
	local cost_revive = (self.qnt_revive - bag_revive) * 1500
	local cost_hyperpot = (self.qnt_hyperpot - bag_hyperpot) * 1200
...
function P28ExpForElite4Kanto:Route22()
...
function P28ExpForElite4Kanto:PokemonLeagueReceptionGate()
...
function P28ExpForElite4Kanto:VictoryRoadKanto1F()
	if dialogs.leagueKantoDone.state then
		sys.debug("quest", "Going to Johto.")
...
function P28ExpForElite4Kanto:VictoryRoadKanto2F()
	if dialogs.leagueKantoDone.state then
		sys.debug("quest", "Going to Johto.")
...
function P28ExpForElite4Kanto:VictoryRoadKanto3F()
...
function P28ExpForElite4Kanto:IndigoPlateau()
	if dialogs.leagueKantoDone.state then
		sys.debug("quest", "Going to Johto.")
...
function P28ExpForElite4Kanto:IndigoPlateauCenter()
	if dialogs.leagueKantoDone.state then
		sys.debug("quest", "Going to Johto.")
