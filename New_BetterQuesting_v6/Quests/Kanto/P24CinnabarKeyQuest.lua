...
local P24CinnabarKeyQuest = Quest:new()

function P24CinnabarKeyQuest:new()
	return Quest.new(P24CinnabarKeyQuest, name, description, level)
end

function P24CinnabarKeyQuest:isDoable()
...
function P24CinnabarKeyQuest:isDone()
...
function P24CinnabarKeyQuest:Cinnabarmansion1()
...
function P24CinnabarKeyQuest:Cinnabarmansion2()
	if not hasItem("Cinnabar Key") then
...
function P24CinnabarKeyQuest:Cinnabarmansion3()
	if not hasItem("Cinnabar Key") then
...
function P24CinnabarKeyQuest:CinnabarmansionB1F()
