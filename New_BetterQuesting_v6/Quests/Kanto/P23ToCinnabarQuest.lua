...
local P23ToCinnabarQuest = Quest:new()

function P23ToCinnabarQuest:new()
	local o = Quest.new(P23ToCinnabarQuest, name, description, level)
	o.pokemonId = 1
	return o
end

function P23ToCinnabarQuest:isDoable()
...
function P23ToCinnabarQuest:isDone()
...
function P23ToCinnabarQuest:isGoodRodObtainable()
	return BUY_RODS and hasItem("Old Rod") and not hasItem("Good Rod") and getMoney() >= 15000
end



function P23ToCinnabarQuest:LavenderTown()
...
function P23ToCinnabarQuest:PokecenterLavender()
	self:pokecenter("Lavender Town")
end

function P23ToCinnabarQuest:LavenderPokemart()
	self:pokemart()
end

function P23ToCinnabarQuest:Route12()
	sys.debug("quest", "Going to Cinnabar Island.")
	return moveToCell(24, 92)
end

function P23ToCinnabarQuest:Route13()
	sys.debug("quest", "Going to Cinnabar Island.")
	return moveToCell(18, 34)
end

function P23ToCinnabarQuest:Route14()
	sys.debug("quest", "Going to Cinnabar Island.")
	return moveToCell(0, 53)
end

function P23ToCinnabarQuest:Route15()
	sys.debug("quest", "Going to Cinnabar Island.")
	return moveToCell(6, 16)
end

function P23ToCinnabarQuest:Route15StopHouse()
	sys.debug("quest", "Going to Cinnabar Island.")
	return moveToCell(0, 6)
end

function P23ToCinnabarQuest:FuchsiaCity()
...
function P23ToCinnabarQuest:PokecenterFuchsia()
		self:pokecenter("Fuchsia City")
end

function P23ToCinnabarQuest:FuchsiaHouse1()
...
function P23ToCinnabarQuest:FuchsiaCityStopHouse()	
	sys.debug("quest", "Going to Cinnabar Island.")
	return moveToCell(6, 20)
end

function P23ToCinnabarQuest:Route19()
...
function P23ToCinnabarQuest:Route20()
...
function P23ToCinnabarQuest:Seafoam1F()
...
function P23ToCinnabarQuest:SeafoamB1F()
	sys.debug("quest", "Going to Cinnabar Island.")
	return moveToCell(85, 22)
end

return P23ToCinnabarQuest